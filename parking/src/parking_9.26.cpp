...
int main(int argc, char **argv)
{
	...
	// VideoCapture cap("/home/user1508/catkin_ws/src/line_detection/src/result.mp4");
	// VideoCapture cap1("/home/user1508/catkin_ws/src/line_detection/src/result.mp4");
	VideoCapture cap(2);
	VideoCapture cap1(6);
...
// 		}
// 		else if (k > -1.1 && k < -0.8) //-1.3 k-city
// 		{
...
// 		if (p[4] > 4000 && p[4] < 13000)//15000 kcity
// 		{
...
// 		if (p[4] > 5000 && p[4] < 11000)  //kcity 11000
// 		{
...
Mat preprocessing_second_level(Mat img)
{
	...
	for (int i = 1; i < cnt4; i++)
	{
		...
		if (p[4] > 4000 && p[4] < 15000) //5000     // 15000 수정
		{
