...
{
	// VideoCapture cap1("/home/usera/catkin_ws/src/stopline_2021/src/stopline_8.17.mp4");
	...
	while (ros::ok())
	{
		...
		double fps = image.get(CAP_PROP_FPS);
		cout << "FPS: " << fps << endl;
...
Mat preprocessing(Mat img)
{
	...
	Mat img_mask;
	img_mask = mask_filter(img_integral, 5, 5, 85); // 5,5,85
