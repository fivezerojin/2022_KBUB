...
{
	VideoCapture cap1("/home/usera/catkin_ws/src/stopline_2021/src/stopline_kcity5.mp4");
...
Mat preprocessing(Mat img)
{
	...
	Scalar upper_white = Scalar(255, 100, 255);  // 색 범위 check!!!!!!!!!
	...
	Mat img_mask;
	img_mask = mask_filter(img_integral, 5, 5, 100); // 5,5,85   120      check!!!!!!!!!!!!!!!!!!!!
