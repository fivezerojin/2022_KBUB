...
int main(int argc, char **argv)
{
    ...
    VideoCapture cap(2);
    // VideoCapture cap("/home/usera/catkin_ws/src/stopline_2021/src/result.mp4");
...
void BoundingBox_callback(darknet_ros_msgs::BoundingBoxes boundingBox)
{
    ...
    if (obj_count != 0)
    {
        ...
        for (int i = 0; i < obj_count; i++)
        {
            ...
            if (Class_name == "A1" && Area>3000 && mission_flag==7)   //1500
            {
                count_A1 += 1;
                Class_name_test="A1";
                A_sign=true;
            ...
            else if (Class_name == "A2" && Area>3000 && mission_flag==7)
            {
                count_A2 += 1;
                A_sign=true;
                cout<<"Area: "<<Area<<endl;
            }
            else if (Class_name == "A3" && Area>3000 && mission_flag==7)
            {
                count_A3 += 1;
                A_sign=true;
                cout<<"Area: "<<Area<<endl;
